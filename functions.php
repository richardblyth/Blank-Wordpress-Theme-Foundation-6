...
// Load jQuery if not using version shipped with WordPress
...
function other_scripts() {
  ...
  //CSS (Change to /Dist for production)
  wp_enqueue_style( 'appcss', get_template_directory_uri() . '/css/app.css', array(), null );
    
  //Head Scripts
  wp_enqueue_script( 'modernizr', get_template_directory_uri() . '/js/dist/modernizr.js', array('jquery'), '3.3.1', false);

  //End of Document Scripts (Change to /Dist for production)
  wp_enqueue_script( 'appjs', get_template_directory_uri() . '/js/dist/app.js', array(), '1.0.0', true );
}
